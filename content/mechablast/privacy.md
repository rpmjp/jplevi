...
one-time **Remove Ads** upgrade that turns off the interstitials.
...
**device advertising identifier** and coarse ad-interaction and diagnostic data. This
is processed by Google as an independent controller under
[Google's Privacy Policy](https://policies.google.com/privacy) and the
[AdMob/Google "How Google uses information"](https://policies.google.com/technologies/partner-sites)
...
- **Opt-in**: on first launch you choose Allow or Decline. Nothing is collected until
  you choose Allow.
- **Opt-out any time**: Settings → Privacy → Analytics turns it off. When off, the app
...
A parent or guardian controls the consent and purchase choices on the device and can
decline or opt out at any time. If you believe a child has provided personal
...
Ad requests are only made when ads are enabled.)

## Legal bases (EEA / UK)

Where the EU/UK GDPR applies, we (and our providers) rely on: **consent** for ads, the
advertising identifier, and optional analytics (you may withdraw it at any time);
**legitimate interests** for security, fraud prevention, and basic app functionality;
and **performance of a contract** for delivering in-app purchases.

## International data transfers

Our providers, including Google, are based in the United States and may process data
outside your country. For transfers of EEA/UK/Swiss data to the U.S., Google relies on
the **EU-U.S. Data Privacy Framework** (and its UK Extension and Swiss-U.S. DPF) and on
**Standard Contractual Clauses** as a safeguard.

## Data retention

We keep data only as long as needed for the purpose it was collected: ad and consent
records for as long as required to serve/measure ads and evidence consent; opt-in
analytics events for a limited period for aggregate tuning; purchase confirmations as
needed to grant items and for our records. Your settings and consent choice are stored
on your device until you change them or uninstall.

## Your privacy rights

Depending on where you live, you may have the right to **access, correct, delete, or
receive a copy of** your personal information; to **object to or restrict** processing;
to **withdraw consent**; to **opt out** of targeted advertising, the "sale" or
"sharing" of personal information, and profiling; and to **not be discriminated
against** for exercising these rights. Because our gameplay analytics is anonymous and
aggregate, it generally cannot be linked back to you individually.

**How to exercise them:** email **support@jplevi.com**, or use the in-app controls
(Settings turns analytics off; the consent form governs ads). To reset the ad consent
choice, clear it in your device's Google/ad settings or reset your advertising
identifier. If you are in the EEA/UK, you also have the right to **complain to your
data-protection supervisory authority** (in the UK, the ICO).
...
behavioral advertising** in the sense those terms are defined by the California
Consumer Privacy Act (CCPA/CPRA) and similar state laws: on iOS the app serves
**non-personalized** ads (no tracking), and elsewhere personalized ads run only where
consent/opt-out settings allow. We honor opt-out preference signals, including **Global
Privacy Control (GPC)**, where applicable. California, Virginia, Colorado, Connecticut,
Texas, New Jersey, and other state residents may exercise the rights above by
contacting support@jplevi.com; we do not discriminate against you for doing so. This
section serves as our **notice at collection**: the categories we collect and the
purposes are described throughout this policy.
...
If a security breach affecting personal information occurs, we will notify affected
users and the appropriate authorities as required by applicable law, including New
Jersey's breach-notification statute.

## EU and UK representatives

If required under Article 27 of the EU/UK GDPR, JP LEVI INC. will appoint an EU
representative and a UK representative and list their contact details here. Until then,
EEA/UK users may contact us directly at support@jplevi.com.

## Changes

If this policy changes, we will update the effective date and the hosted page.

_Questions or requests: contact us at support@jplevi.com. Your use of MechaBlast is
also governed by the [Terms of Service](/mechablast/terms)._
